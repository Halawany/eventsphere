# Generated by Django 4.2.3 on 2023-07-14 04:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('price', models.DecimalField(decimal_places=2, max_digits=15, validators=[eventAPI.validators.AllowPositiveDecimalValuesOnly])),
                ('available_quantity', models.PositiveIntegerField(validators=[eventAPI.validators.ticket_available_quantity_validator])),
